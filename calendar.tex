...
\foreach \age in {\firstyear,...,\lastyear} {
  ...
  % left: year of age
  \node[anchor=east] at (0,-6mm*\age) {\age};
  ...
  \ifnum\value{datedayname}>1
     ...
     \node[rotate=180,partial=\thefirstweek] at (6mm,-6mm*\age) {};
  \else
     % full week (starting at monday)
     \setcounter{firstweek}{7}
     \node[week] at (6mm,-6mm*\age) {};
  \fi
  ...
  \pgfmathsetlengthmacro{\startofyear}{9.0mm-\thefirstweek*6mm/7}
